...
export default function DocumentSummarizerScreen(){
 const colors=useColors(),params=useLocalSearchParams<{documentId?:string}>(); const [doc,setDoc]=useState<any>(null),[summary,setSummary]=useState(''),[status,setStatus]=useState(''),[busy,setBusy]=useState(false);
