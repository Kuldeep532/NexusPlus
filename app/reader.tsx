...
export default function ReaderScreen() {
  ...
  useEffect(() => {
    let active = true;
    Promise.all([loadBooks(), getInstalledVoices()]).then(([loadedBooks, loadedVoices]) => {
      if (!active) return;
...
const styles = StyleSheet.create({ screen: { flex: 1, paddingTop: 14 }, hero: { marginHorizontal: 20, borderRadius: 20, borderWidth: 1, padding: 16, flexDirection: 'row', alignItems: 'center', marginBottom: 18 }, heroCopy: { flex: 1, marginRight: 14 }, kicker: { fontSize: 10, letterSpacing: 1.7, fontFamily: 'Inter_700Bold', marginBottom: 7 }, title: { fontSize: 25, lineHeight: 30, fontFamily: 'Inter_700Bold', marginBottom: 5 }, meta: { fontSize: 11, fontFamily: 'Inter_400Regular' }, cover: { width: 84, height: 104, borderRadius: 14, alignItems: 'center', justifyContent: 'center', gap: 7 }, coverLabel: { fontSize: 9, letterSpacing: 1.2, fontFamily: 'Inter_700Bold' }, sectionHeader: { paddingHorizontal: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }, sectionTitle: { fontSize: 18, fontFamily: 'Inter_700Bold', marginBottom: 3 }, sectionDetail: { fontSize: 11, fontFamily: 'Inter_400Regular' }, importButton: { minHeight: 42, paddingHorizontal: 12, borderRadius: 12, flexDirection: 'row', alignItems: 'center', gap: 6 }, importText: { fontSize: 11, fontFamily: 'Inter_700Bold' }, bookList: { paddingHorizontal: 20, gap: 8 }, bookRow: { minHeight: 72, borderRadius: 15, borderWidth: 1, paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center' }, bookIcon: { width: 44, height: 44, borderRadius: 12, alignItems: 'center', justifyContent: 'center' }, bookCopy: { flex: 1, marginHorizontal: 10 }, bookTitle: { fontSize: 13, fontFamily: 'Inter_700Bold', marginBottom: 4 }, bookMeta: { fontSize: 10, fontFamily: 'Inter_400Regular', marginBottom: 7 }, track: { height: 4, borderRadius: 2, overflow: 'hidden' }, fill: { height: 4, borderRadius: 2 }, readerCard: { marginHorizontal: 20, marginTop: 18, borderRadius: 18, borderWidth: 1, padding: 14 }, cardTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, cardKicker: { fontSize: 9, letterSpacing: 1.5, fontFamily: 'Inter_700Bold', marginBottom: 4 }, cardTitle: { fontSize: 15, fontFamily: 'Inter_700Bold' }, iconButton: { width: 42, height: 42, borderRadius: 12, alignItems: 'center', justifyContent: 'center' }, voicePanel: { marginTop: 12, borderRadius: 14, borderWidth: 1, padding: 11 }, voiceHeading: { fontSize: 13, fontFamily: 'Inter_700Bold', marginBottom: 3 }, voiceHint: { fontSize: 10, lineHeight: 15, fontFamily: 'Inter_400Regular', marginBottom: 8 }, voiceRow: { minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: 8 }, voiceCopy: { flex: 1 }, voiceName: { fontSize: 11, fontFamily: 'Inter_600SemiBold', marginBottom: 2 }, voiceLanguage: { fontSize: 9.5, fontFamily: 'Inter_400Regular' }, manageVoiceButton: { minHeight: 40, marginTop: 7, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, manageVoiceText: { fontSize: 11, fontFamily: 'Inter_700Bold' }, playerLine: { marginTop: 15, flexDirection: 'row', alignItems: 'center', gap: 10 }, playButton: { width: 48, height: 48, borderRadius: 24, alignItems: 'center', justifyContent: 'center' }, playerCopy: { flex: 1 }, currentVoice: { fontSize: 12, fontFamily: 'Inter_700Bold' }, currentText: { fontSize: 10, marginTop: 3 }, speedButton: { minHeight: 40, borderRadius: 12, borderWidth: 1, paddingHorizontal: 11, alignItems: 'center', justifyContent: 'center' }, speedText: { fontSize: 11, fontFamily: 'Inter_700Bold' }, optionList: { marginTop: 14, gap: 8 }, optionRow: { minHeight: 46, borderWidth: 1, borderRadius: 12, paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center', gap: 9 }, optionLabel: { flex: 1, fontSize: 11, fontFamily: 'Inter_600SemiBold' }, optionValue: { fontSize: 10 }, pressed: { opacity: 0.82 } });
