 ...
 return <View style={[styles.root,{backgroundColor:colors.background}]}>
  <ScrollView contentContainerStyle={[styles.content,{paddingTop:insets.top+12,paddingBottom:insets.bottom+24}]}>
   ...
   <View style={[styles.card,{backgroundColor:colors.card,borderColor:colors.border}]}>
    ...
    <Text style={[styles.body,{color:colors.mutedForeground}]}>Choose the greeting shown with your daily spiritual message on Home.</Text>
    <View style={styles.modeList}>{([
