...
export default function EPaperGeneratorScreen() {
  const colors = useColors(); const insets = useSafeAreaInsets(); const { width: viewportWidth } = useWindowDimensions();
      ...
      >
        <View style={styles.header}>
          ...
          <View style={styles.headerCopy}>
            ...
            <Text style={[styles.subtitle, { color: colors.mutedForeground }]}>Deterministic, offline-first newspaper layout. No AI required.</Text>
          </View>
        </View>
