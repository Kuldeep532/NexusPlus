...
export class OnvifCctvProtocolAdapter implements CctvProtocolAdapter {
  ...
  async setControl(context: CctvTransportContext, control: CctvCameraControl, payload?: Record<string, unknown>): Promise<void> { const capability = control === 'ptz' ? 'panTiltZoom' : 'playback'; assertCapability(context.camera, capability); await this.control(context, control, payload); }
}
...
export class UnsupportedCctvProtocolAdapter implements CctvProtocolAdapter {
  ...
  async discover(): Promise<never> { return this.unsupported(); } async connect(): Promise<never> { return this.unsupported(); } async disconnect(): Promise<never> { return this.unsupported(); } async startLiveView(): Promise<never> { return this.unsupported(); } async stopLiveView(): Promise<never> { return this.unsupported(); } async startRecording(): Promise<never> { return this.unsupported(); } async stopRecording(): Promise<never> { return this.unsupported(); } async searchRecordings(): Promise<never> { return this.unsupported(); } async setControl(): Promise<never> { return this.unsupported(); }
}
