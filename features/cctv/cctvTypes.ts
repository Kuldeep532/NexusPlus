...
export interface CctvCapabilities { liveView: boolean; audio: boolean; recordings: boolean; playback: boolean; eraseData: boolean; passwordChange: boolean; discovery: boolean; multiCamera: boolean; switchCamera: boolean; flip: boolean; panTiltZoom: boolean; nightVision: boolean; talk: boolean; }
export interface CctvCamera { id: string; name: string; serialNumber?: string; model?: string; manufacturer?: string; protocol: CctvProtocol; deviceKind?: CctvDeviceKind; host?: string; port?: number; username: string; passwordRef: string; createdAt: number; updatedAt: number; capabilities: CctvCapabilities; authenticationProfile?: CctvAuthenticationProfile; securityProfile?: CctvSecurityProfile; }
