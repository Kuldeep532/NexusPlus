...
export const VISION_ASSIST_CAPABILITIES: VisionAssistCapability[] = [
  ...
  { id: 'describe-image', title: 'Describe Image', description: 'Describe a user-selected image using an already-configured Nexus vision provider.', risk: 'safe', offline: false },
  { id: 'describe-video', title: 'Describe Video', description: 'Video description is enabled only when an existing lightweight ML Kit vision workflow can process frames without adding a new bundled model.', risk: 'safe', offline: false },
