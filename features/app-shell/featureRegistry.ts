...
const registry: HomeFeatureDefinition[] = [
  ...
  { id: 'geeta-nexus', title: 'Bhagavad Gita', description: 'Read and listen to the Bhagavad Gita with chapter progress and offline support.', route: '/geeta-nexus', icon: 'book-open', category: 'productivity', featured: true, order: 88 },
