...
const registry: HomeFeatureDefinition[] = [
  ...
  { id: 'nexus-vision-assist', title: 'Nexus Vision Assist', description: 'Accessibility-first agent for screen, image and video understanding.', route: '/nexus-vision-assist', icon: 'eye', category: 'productivity', featured: true, order: 83 },
