...
const registry: HomeFeatureDefinition[] = [
  ...
  { id: 'era-ai', title: 'Era AI', description: 'Spiritual-only bilingual guidance for Gita, life reflection and habit improvement.', route: '/era-ai', icon: 'heart', category: 'productivity', featured: true, order: 0 },
  { id: 'geeta-nexus', title: 'Geeta Nexus', description: 'The primary spiritual experience of Nexus Plus: read the Bhagavad Gita with chapter progress and offline support.', route: '/geeta-nexus', icon: 'book-open', category: 'productivity', featured: true, order: 1 },
  { id: 'open-assets', title: 'Open Assets', description: 'Browse the complete supplied collection of sacred-text datasets.', route: '/open-assets', icon: 'archive', category: 'productivity', featured: true, order: 2 },
  ...
  { id: 'video-generator', title: 'Video Generator', description: 'Create AI-generated videos from text descriptions.', route: '/video-generator', icon: 'video', category: 'media', featured: true, order: 88 },
...
export const FEATURE_CATEGORY_META: Record<FeatureCategory, { title: string; description: string; icon: string; route: string }> = {
  utility: { title: 'Utility Tools', description: 'AI calculator, links, QR tools, Sketch Generator, clock, time and everyday accessibility utilities.', icon: 'clock', route: '/categories/utility-tools' },
