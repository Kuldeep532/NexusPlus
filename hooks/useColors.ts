...
export function refreshThemeColor(theme: ThemeColor) { selectedTheme = theme; listeners.forEach((listener) => listener()); }
export function useColors(): PaletteTokens {
  ...
  return { ...tokens, ink: tokens.foreground, radius } as PaletteTokens;
}