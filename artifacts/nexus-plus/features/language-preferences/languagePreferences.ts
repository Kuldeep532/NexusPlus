...
const DEFAULTS: LanguagePreferences = { featureTtsLanguage: 'en-IN', bookReaderLanguage: 'en-IN' };
...
export async function getFeatureTtsLanguage(): Promise<FeatureTtsLanguage> {
  return (await loadLanguagePreferences()).featureTtsLanguage;
}

export async function getBookReaderLanguage(): Promise<FeatureTtsLanguage> {
  return (await loadLanguagePreferences()).bookReaderLanguage;
}
