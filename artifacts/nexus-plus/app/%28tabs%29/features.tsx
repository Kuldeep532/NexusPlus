...
const features: Feature[] = [
  { key: 'reader', title: 'Book Reader', detail: 'Library, import, OCR, audio reading and voice selection', icon: 'book-open-page-variant', route: '/reader' },
  { key: 'media', title: 'Media Player', detail: 'Audio and video playback', icon: 'play-box-multiple', route: '/media-player' },
  ...
  { key: 'voices', title: 'Voice Library', detail: 'Only voices marked as downloaded are shown to Reader', icon: 'account-voice', route: '/voices' },
  ...
  return (
    ...
    >
      <View style={styles.heading}>
        ...
        <Text accessibilityRole="header" style={[styles.title, { color: colors.foreground }]}>All Features</Text>
        <Text style={[styles.subtitle, { color: colors.mutedForeground }]}>One clean, accessible list. New features can be added here without changing the home layout.</Text>
      </View>
